...
/* Generated by nanopb-0.3.9.2 at Sun Mar 10 18:57:30 2019. */
...
const pb_field_t ArcLayerPropsMessage_fields[15] = {
    ...
    PB_FIELD(  8, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, endAngleChanged, thickness, 0),
    PB_FIELD(  9, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, startAngleChanged, endAngleChanged, 0),
    PB_FIELD( 10, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, radiusChanged, startAngleChanged, 0),
    PB_FIELD( 11, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, layerPropsChanged, radiusChanged, 0),
    PB_FIELD( 12, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, strokeColorChanged, layerPropsChanged, 0),
    PB_FIELD( 13, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, strokeWidthChanged, strokeColorChanged, 0),
    PB_FIELD( 14, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, thicknessChanged, strokeWidthChanged, 0),
    PB_LAST_FIELD
};
