...
/* Generated by nanopb-0.3.9.2 at Fri Mar  8 15:24:00 2019. */
...
const pb_field_t ArcLayerPropsMessage_fields[9] = {
    ...
    PB_FIELD(  5, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, endAngleChanged, layerProps, 0),
    PB_FIELD(  6, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, startAngleChanged, endAngleChanged, 0),
    PB_FIELD(  7, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, radiusChanged, startAngleChanged, 0),
    PB_FIELD(  8, BOOL    , SINGULAR, STATIC  , OTHER, ArcLayerPropsMessage, layerPropsChanged, radiusChanged, 0),
    PB_LAST_FIELD
};
