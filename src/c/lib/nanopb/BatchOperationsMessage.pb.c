...
/* Generated by nanopb-0.3.9.2 at Sat Mar  2 14:51:23 2019. */
...
const pb_field_t OperationMessage_fields[8] = {
    ...
    PB_FIELD(  6, MESSAGE , SINGULAR, POINTER , OTHER, OperationMessage, layerProps, animationProps, &LayerPropsMessage_fields),
    PB_FIELD(  7, MESSAGE , SINGULAR, POINTER , OTHER, OperationMessage, circleLayerProps, layerProps, &CircleLayerPropsMessage_fields),
    PB_LAST_FIELD
};
