...
#define OperationMessage_init_default            {0, 0, NULL, NULL, NULL}
...
#define OperationMessage_init_zero               {0, 0, NULL, NULL, NULL}
...
extern const pb_field_t OperationMessage_fields[6];
