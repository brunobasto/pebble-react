...
#define AnimationPropsMessage_duration_tag       1
#define AnimationPropsMessage_delay_tag          2
#define AnimationPropsMessage_startOperations_tag 3
#define AnimationPropsMessage_endOperations_tag  4
#define AnimationPropsMessage_durationChanged_tag 5
#define AnimationPropsMessage_delayChanged_tag   6
