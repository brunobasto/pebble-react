...
#define TextLayerPropsMessage_init_default       {NULL, NULL, NULL, 0, 0, 0}
...
#define OperationMessage_animationProps_tag      5
#define OperationMessage_layerProps_tag          6
#define OperationMessage_circleLayerProps_tag    7
#define TextLayerPropsMessage_alignment_tag      1
#define TextLayerPropsMessage_text_tag           2
#define TextLayerPropsMessage_layerProps_tag     3
#define TextLayerPropsMessage_alignmentChanged_tag 4
#define TextLayerPropsMessage_textChanged_tag    5
#define TextLayerPropsMessage_layerPropsChanged_tag 6

/* Struct field encoding specification for nanopb */
extern const pb_field_t LayerPropsMessage_fields[9];
extern const pb_field_t TextLayerPropsMessage_fields[7];
extern const pb_field_t CircleLayerPropsMessage_fields[5];
extern const pb_field_t AnimationPropsMessage_fields[11];
extern const pb_field_t OperationMessage_fields[8];
